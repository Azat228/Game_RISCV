/*
 * Colours_predefined.h
 *
 *  Created on: 16 Aug 2025
 *      Author: azati
 */

#ifndef USER_GAME_HELP_FUNC_COLOURS_PREDEFINED_H_
#define USER_GAME_HELP_FUNC_COLOURS_PREDEFINED_H_
...
#endif /* USER_GAME_HELP_FUNC_COLOURS_PREDEFINED_H_ */
